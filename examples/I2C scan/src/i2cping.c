//# [https://github.com/ProjectsByJRP/i2cping]
...
#include <ftD2XX/ftd2xx.h>
	...
	DWORD dwClockDivisor = 0x00C8;		// 100khz -- 60mhz / ((1+dwClockDivisor)*2) = clock speed in mhz
...
int main(int argc, char *argv[])
{
	...
	//printf("Enabling internal loopback...");
        ...
        //printf("Synchronizing bad command handling:\n");
        //printf("Sending bogus command 0xAA...");
        ...
        //printf("Bad command handling synchronized.\n");
...
// ##############################################################
// 
// This is where the program more or less starts
//
// ##############################################################
// ##############################################################
